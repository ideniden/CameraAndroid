 ...
 * @author LuoJ
 * @date 2014-7-31
 * @package j.android.library.utils -- LogUtils.java
 * @Description 日志输出工具类
 */
...
//    public static boolean allowWtf = true;
    ...
    private static void handleLog(final int level,final String tag,final String content){
    	if (null!=logListeners&&!logListeners.isEmpty()) {
    		for (final LogListener listener : logListeners.values()) {
